        ...
        <div>
            ...
            <div className="drawer drawer-mobile">
                ...
                <div className="drawer-side">
                    ...
                    <div className="flex flex-col w-64 h-screen px-4 py-8 bg-white lg:bg-inherit border-r dark:bg-gray-900 dark:border-gray-700">
                        <img src={logo} alt="logog" className='hidden lg:block' />
                        <div className="flex flex-col items-center mt-6 -mx-2 lg:bg-inherit">
